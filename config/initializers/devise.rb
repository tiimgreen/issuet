...
Devise.setup do |config|
  ...
  config.secret_key =
  '77c6cbae5fdfd937adec13cb31d5e94beadb813fb3ff39b9c1a9ee6b45445a21c05b8f5'\
  '7db4adc6d7bf0e06c63162d07c5fc6eeac735194de5e095d35f1d2bf2'
  ...
  # find_for_authentication method and considered in your model lookup.
   # For instance,
  # if you set :request_keys to [:subdomain], :subdomain will be used
   # on authentication.
  ...
  # :database      = Support basic authentication with
  ...
  # For bcrypt, this is the cost for hashing the password and defaults to
   # 10. If
  # using other encryptors, it sets how many times you want the
   # password re-encrypted.
  #
  # Limiting the stretches to just one in testing will increase the
   # performance of
  # your test suite dramatically. However, it is STRONGLY RECOMMENDED
   # to not use
  ...
  # Allow you to use another encryption algorithm besides bcrypt (default). Y
   # ou can use
  # :sha1, :sha512 or encryptors from others authentication tools
   # as :clearance_sha1,
  # :authlogic_sha512 (then you should set stretches above to 20 for
   # default behavior)
  # and :restful_authentication_sha1 (then you should set stretches to
   # 10, and copy
